...
const EMPTY = {
  ...
  slots:{nss_disponible:null,curp_disponible:null},
...
function deepMerge(base,patch){
  ...
  for(const key of ["intereses","contexto_laboral","ventas","intent","caso_fallecimiento","flujo","slots","experiencia"]){out[key]={...(base[key]||{}),...(patch[key]||{})};}
  return out;
}
