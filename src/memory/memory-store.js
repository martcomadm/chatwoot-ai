...
function deepMerge(base,patch){
  ...
  for(const key of ["intereses","contexto_laboral","ventas","intent","caso_fallecimiento","caso_sujeto","pension_data","orchestration","flujo","slots","experiencia"]){out[key]={...(base[key]||{}),...(patch[key]||{})};}
  return out;
}
