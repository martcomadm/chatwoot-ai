...
const EMPTY = {
  ...
  preguntas_realizadas:[],resolved_questions:[],blocked_questions:[],conflictos_resueltos:[],
  ...
  judgment:{price_requests:0,trust_signals:0,last_question_type:null,last_objection:null,human_preference:false},
...
function deepMerge(base,patch){
  ...
  for(const key of ["intereses","contexto_laboral","ventas","intent","caso_fallecimiento","caso_sujeto","pension_data","orchestration","judgment","handoff","flujo","slots","experiencia"]){out[key]={...(base[key]||{}),...(patch[key]||{})};}
  return out;
}
