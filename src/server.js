...
try {
  ...
  app.listen(config.port, "0.0.0.0", () => {
    console.log(`MARTCOM AI V3.3.2.1 escuchando en puerto ${config.port}`);
    ...
    console.log(`Inspector: /inspector · versión 1.5.2`);
  ...
  console.error("No se pudo iniciar MARTCOM AI V3.3.2.1:", error);
  process.exit(1);
}
