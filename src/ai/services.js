...
export class AiServices {
  ...
  async extractDocumentData(attachments = []) {
    ...
    const content=[{type:"input_text",text:"Analiza estos documentos del titular. Extrae solo datos claramente visibles. Devuelve solo JSON: {\\\"nombre\\\":null,\\\"curp_valor\\\":null,\\\"nss_valor\\\":null,\\\"curp_recibida\\\":false,\\\"nss_recibido\\\":false}. CURP debe tener 18 caracteres válidos de formato y NSS exactamente 11 dígitos. No inventes ni completes caracteres ilegibles."},...images.map(image_url=>({type:"input_image",image_url,detail:"high"}))];
