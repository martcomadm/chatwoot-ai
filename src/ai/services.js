...
export function mergeMemory(current, ...patches) {
  ...
  for (const patch of patches) {
    ...
    for (const key of ["primer_nombre","edad","actividad","tipo_trabajo","tiene_imss","ultima_cotizacion","necesidad_principal","afore_actual","asesor_presentacion","curp_valor"]) {
